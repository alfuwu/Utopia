...
class Game {
  ...
  talents = {
    ...
    inventiveHuman: { tree: Constants.SPECIES, name: "Inventive", after: null, requirements: [{ type: Constants.SPECIES, species: "human" }], body: 0, mind: 1, soul: 1, description: "When crafting an item other than a component, you require 1 less material component of your choice, minimum of 1.", actions: [{ type: Constants.CRAFTING }] },
    ...
    // warfare core tree
    cleave: { tree: Constants.WARFARE, name: "Cleave", after: null, body: 1, mind: 0, soul: 1, description: "When a melee weapon attack you make reduses a creature's DHP to 0, you may retarget the remaining damage to another creature within the weapon's range.", actions: [] },
    ...
    intellectual: { tree: Constants.INNOVATION, name: "Intellectual", after: "mnemonic", body: 2, mind: 6, soul: 0, description: "Whenever a creature within 5 meters of you makes a test, given you can both sense each other, you may spend 1 interrupt action to add your Intellect modifier to its roll.", actions: [] },
